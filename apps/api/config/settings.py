...
RECOVERY_REQUEST_RATE_WINDOW_SECONDS = int(
    os.getenv("RECOVERY_REQUEST_RATE_WINDOW_SECONDS", "3600")
)
RECOVERY_REQUEST_IP_LIMIT = int(os.getenv("RECOVERY_REQUEST_IP_LIMIT", "5"))
RECOVERY_REQUEST_EMAIL_LIMIT = int(os.getenv("RECOVERY_REQUEST_EMAIL_LIMIT", "3"))
ACCESS_AUTH_RATE_LIMIT = int(os.getenv("ACCESS_AUTH_RATE_LIMIT", "20"))
...
OFFLINE_LICENSE_TTL_HOURS = int(os.getenv("OFFLINE_LICENSE_TTL_HOURS", "24"))
